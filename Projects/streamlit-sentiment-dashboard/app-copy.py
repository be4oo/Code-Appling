...
st.markdown("This app performs sentiment analysis of tweets about US Airlines")
st.sidebar.markdown("This app performs sentiment analysis of tweets about US Airlines")
